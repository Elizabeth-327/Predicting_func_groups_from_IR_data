"""Calculates probability thresholds for the classification of each functional group. Written by Guwon Jung.
My modifications: keep last 2 columns in training + val sets, adjust optimal_threshold function to account for all functional groups in y_train_val instead of only 37 functional groups."""
